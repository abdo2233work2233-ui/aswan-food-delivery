  ...
  const handleCancelOrder = async () => {
    ...
    try {
      ...
      if (cancelOrder.fulfilled.match(result)) {
        ...
        toast.error((result.payload as string) || (isArabic ? 'فشل في إلغاء الطلب' : 'Failed to cancel order'));
      }
    } catch (error) {
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-soft p-6 sticky top-24">
              ...
              <div className="mt-4 pt-4 border-t border-neutral-200">
                ...
                {/* Payment Status & Button for Card Payments */}
                    ...
                    {order.paymentStatus === PaymentStatus.PENDING ? (
                      <div className="space-y-3">
                        ...
                        >
                          ...
                          <span>{isArabic ? 'أكمل الدفع' : 'Complete Payment'}</span>
                        </button>
                      </div>
                    ) : order.paymentStatus === PaymentStatus.COMPLETED ? (
                      <div className="flex items-center space-x-2 rtl:space-x-reverse p-3 bg-green-50 border border-green-200 rounded-lg">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center space-x-2 rtl:space-x-reverse p-3 bg-red-50 border border-red-200 rounded-lg">
                        ...
                        >
                          <FiCheckCircle className="h-4 w-4" />
                          <span>{isArabic ? 'إعادة المحاولة' : 'Retry Payment'}</span>
                        </button>
                      </div>
                    ) : null}
                  </div>
            ...
            {(order.status === OrderStatus.PENDING || order.status === OrderStatus.CONFIRMED) && (
              <div className="bg-white rounded-xl shadow-soft p-6">
                ...
                <button 
                  onClick={() => setShowCancelDialog(true)}
                  className="btn bg-red-500 text-white hover:bg-red-600 w-full flex items-center justify-center space-x-2 rtl:space-x-reverse"
                >
