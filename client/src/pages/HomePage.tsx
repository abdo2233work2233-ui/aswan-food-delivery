...
import { fetchRestaurants, selectRestaurants, selectRestaurantLoading, searchRestaurantsAndItems } from '../store/slices/restaurantSlice';
...
const HomePage: React.FC = () => {
  ...
  const handleSuggestionClick = (suggestion: SearchResult) => {
    // Navigate to restaurants page with the suggestion
