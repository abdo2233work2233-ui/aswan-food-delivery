...
class SocketService {
  ...
  offDriverLocation(callback?: (...args: any[]) => void): void {
    if (callback) {
  ...
  offNewOrder(callback?: (...args: any[]) => void): void {
    if (callback) {
  ...
  offNotification(callback?: (...args: any[]) => void): void {
    if (callback) {
  ...
  offBroadcast(callback?: (...args: any[]) => void): void {
    if (callback) {
