                      ...
                      <div className="flex items-start space-x-3 rtl:space-x-reverse">
                        ...
                        <div className="w-16 h-16 bg-neutral-200 rounded-lg overflow-hidden flex-shrink-0">
                          <Image
                            ...
                            fallbackText={isArabic ? item.menuItem.nameAr.charAt(0) : item.menuItem.name.charAt(0)}
                          />
                        </div>
              ...
              <div className="border-t border-neutral-200 p-4 space-y-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      {cart.deliveryFee === 0 ? (
                        ...
                        `${cart.deliveryFee} ${isArabic ? 'ج.م' : 'EGP'}`
                      )}
                    </span>
                  </div>
                  
                  {cart.deliveryFee > 0 && cart.subtotal < 100 && (
                    <div className="text-xs text-blue-600 bg-blue-50 p-2 rounded">
                      {isArabic 
                        ? 'احصل على توصيل مجاني عند الطلب بقيمة 100 ج.م أو أكثر'
                        : 'Get free delivery on orders of 100 EGP or more'
                      }
                    </div>
                  )}
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>{cart.tax} {isArabic ? 'ج.م' : 'EGP'}</span>
                  </div>
